    ...
    return (
        <div>
            <h3 className="text-3xl w-full text-center mb-5 mt-5 sm:text-start sm:ml-10">
                <span className="text-blue-400">Ponte </span> en contacto
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-0 justify-items-certer sm:text-2xl">
                ...
                <div className="w-full md:w-3/4 lg:w-1/2 xl:w-2/3 mx-auto mb-5 mt-3">
                    <iframe
                        className="w-full h-64 md:h-96 md:w-[640px] md:mr-2 lg:h-128 xl:h-144"
