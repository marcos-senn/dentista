...
const Contact = () => {
    return (
        <div id="contact">
            <div className="w-3/4"> 
                <h3 className="text-3xl ml-10 text-center mb-5 mt-5 sm:text-start sm:ml-24 sm:absolute">
                    <span className="">Ponte </span> <span className="text-blue-400">en contacto</span>
                </h3>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-0 justify-items-certer sm:text-2xl ">
                <div className="sm:col-start-1 sm:col-span-1 sm:self-center">
                    <div className="text-2xl text-slate-500 flex flex-col items-center sm:items-start  lg:ml-40 gap-y-6 ">
                        <div className="flex items-center sm:mb-5 gap-3 hover:text-blue-400">
                        ...
                        <div className="flex items-center sm:mb-2 gap-3  hover:text-blue-400">
                            <span className="sm:ml-24">
                                <img
                                    src={location}
                                    alt="Icono de correo electrónico"
                ...
                <div
                    className="container md:w-3/4 lg:w-1/2 xl:w-2/3 mx-auto mb-5 mt-3"
                    style={{ width: "90%" }}
                >
                    <iframe
