...
const App: React.FC = () => (
    <div className="w-full flex flex-col items-center justify-center gap-y-3 mt-10">
      <div className='flex items-center justify-center w-full p-5 text-4xl '>
         <p className="text-start">Ofrecemos un completo listado de servicios generales y cosmeticos para tu cuidado bucal</p>
      </div>
